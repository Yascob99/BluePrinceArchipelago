...
namespace BluePrinceArchipelago.FsmMethods.CustomMethods
{
    ...
    public class ItemPickedUp(string itemName) : RegisteredCustomFsmMethod
    {
        public new string Name { get; set; } = CustomFsmMethodManager.GetItemPickedUpMethodName(itemName);
